...
if uploaded_file:
    ...
    if map_df:
        ...
        st.pydeck_chart(pdk.Deck(map_style='mapbox://styles/mapbox/streets-v12',map_style='mapbox://styles/mapbox/light-v9',layers=[layer], initial_view_state=view_state, tooltip={"text": "{tooltip}"}))
